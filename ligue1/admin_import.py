...
admin_import_site.register(models.SaisonCourante, SaisonCouranteAdmin)
admin_import_site.register(models.Saison, SaisonAdmin)
admin_import_site.register(models.Journee, JourneeAdmin)
admin_import_site.register(models.Joueur)
