...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^leagues/(?P<league_pk>[0-9]+)/playersfordraft$',
        league.PlayersForDraftView.as_view(),
        name='playersfordraft-list'),
    url(r'^leagues/(?P<league_pk>[0-9]+)/playersformv$',
        league.PlayersForMVView.as_view(),
        name='playersformv-list'),
    ...
    url(r'^draftsessions/(?P<pk>[0-9]+)$',
        league.DraftSessionView.as_view(),
        name='draftsession-detail'),
